...
use arbos::l1_pricing::{
    ...
    FUNDS_DUE_FOR_REWARDS_OFFSET as L1_FUNDS_DUE_FOR_REWARDS_OFFSET, INERTIA_OFFSET as L1_INERTIA_OFFSET,
    LAST_SURPLUS_OFFSET as L1_LAST_SURPLUS_OFFSET, LAST_UPDATE_TIME_OFFSET as L1_LAST_UPDATE_TIME_OFFSET,
    ...
    PER_UNIT_REWARD_OFFSET as L1_PER_UNIT_REWARD_OFFSET, PRICE_PER_UNIT_OFFSET as L1_PRICE_PER_UNIT_OFFSET,
    UNITS_SINCE_OFFSET as L1_UNITS_SINCE_UPDATE_OFFSET,
};
use arbos::l2_pricing::{
    BACKLOG_TOLERANCE_OFFSET as L2_BACKLOG_TOLERANCE_OFFSET, BASE_FEE_WEI_OFFSET as L2_BASE_FEE_OFFSET,
    GAS_BACKLOG_OFFSET as L2_GAS_BACKLOG_OFFSET, MIN_BASE_FEE_WEI_OFFSET as L2_MIN_BASE_FEE_OFFSET,
