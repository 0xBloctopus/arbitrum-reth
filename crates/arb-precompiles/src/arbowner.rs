...
const SET_GAS_PRICING_CONSTRAINTS: [u8; 4] = [0x55, 0x93, 0xac, 0xb6];
...
const SET_WASM_MIN_INIT_GAS: [u8; 4] = [0x80, 0xa3, 0xa5, 0xe4];
...
const SET_CALLDATA_PRICE_INCREASE: [u8; 4] = [0x63, 0x78, 0x1c, 0x1f];
